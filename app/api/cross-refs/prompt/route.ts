...
export async function POST(request: NextRequest) {
  try {
    ...
    const rateLimitResult = await rateLimitService.checkLimit(clientId, 'prompt')
...
export async function GET() {
  const templates = {
    default: {
      ...
      description: 'General cross-reference analysis suitable for most study purposes',
      use_case: 'Bible study, general research, comparative analysis'
    },
    study: {
      name: 'Study Guide',
      description: 'Structured analysis with study questions and practical applications',
      use_case: 'Group studies, lesson preparation, educational contexts'
    },
    devotional: {
      name: 'Devotional Reflection',
      description: 'Personal reflection focused on spiritual growth and practical application',
      use_case: 'Personal devotions, spiritual reflection, meditation'
    },
    academic: {
      name: 'Academic Research',
      description: 'Scholarly analysis with historical, cultural, and linguistic considerations',
