      ...
      >
        ...
        >
          ...
          <div className="border-t-[12px] border-[#403e3e] rounded-t-[24px] pt-8 px-6">
            {/* Reference title */}
            <h3 className="text-[24px] font-bold text-[#403e3e] underline mb-4" style={{ fontFamily: 'Calibri, sans-serif', lineHeight: '1.4', textUnderlinePosition: 'from-font' }}>
              {crossRefReference || 'Cross Reference'}
            </h3>

            {/* Reference text */}
            <div className="text-[24px] text-[#403e3e] mb-0" style={{ fontFamily: 'Calibri, sans-serif', lineHeight: '1.5' }}>
              {crossRefText ? (
                <p>
                ...
                <p className="text-gray-500 text-base">Select a cross-reference to view its text</p>
              )}
            </div>
          </div>
          ...
          <div className="bg-[rgba(64,62,62,0.2)] rounded-b-[24px] p-7 mt-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-[20px] font-bold text-[#403e3e]" style={{ fontFamily: 'Calibri, sans-serif', lineHeight: '1.4' }}>
            ...
            {aiResponse && (
              <div className="mb-4 p-4 bg-white rounded-2xl text-[#403e3e]">
                <div className="text-base whitespace-pre-wrap" style={{ fontFamily: 'Calibri, sans-serif' }}>
                  {aiResponse.content}
                </div>
              </div>
            )}
