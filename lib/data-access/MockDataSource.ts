        ...
        items: [
          {
            ...
            confidence: 85,
            reasoning:
              'Both passages reference the reign of King Herod as historical context',
          },
          {
            anchor_ref: 'Matthew.2.1',
          ...
          },
          {
            ...
            confidence: 88,
            reasoning:
              'Prophecy of a star rising from Jacob, fulfilled in the star that led the wise men',
          },
          {
            anchor_ref: 'Matthew.2.2',
            cross_ref: 'Jer.23.5',
            ...
            confidence: 82,
            reasoning:
              'Prophecy of the coming king that the wise men came to worship',
          },
          {
            anchor_ref: 'Matthew.2.2',
            cross_ref: 'Rev.22.16',
          ...
          },
          {
            ...
            confidence: 90,
            reasoning:
              'Both passages reference the prophecy that the Messiah would be born in Bethlehem',
          },
          {
