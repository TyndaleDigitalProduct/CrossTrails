      ...
      notes: [
        {
          id: 'TOSN_Matthew_2_1',
          content:
            "The birth of Jesus in Bethlehem during Herod's reign establishes both the historical context and prophetic fulfillment. Bethlehem, though small, was significant as David's birthplace and the prophesied location of the Messiah's birth.",
          summary:
            "Historical and prophetic significance of Jesus' birth in Bethlehem",
          themes: [
            'birth_narrative',
      ...
      notes: [
        {
          id: 'TOSN_Matthew_2_2',
          content:
            'The wise men\'s question reveals their understanding of Jesus as the "king of the Jews." Their reference to "his star" connects to Old Testament prophecies about a ruler emerging from Israel, particularly Numbers 24:17.',
          summary:
            "The wise men recognize Jesus' royal identity through the star",
      ...
      notes: [
        {
          id: 'TOSN_Matthew_2_6',
          content:
            'This quotation from Micah 5:2 demonstrates Matthew\'s pattern of showing how Jesus fulfills Old Testament prophecy. The modification of "least" to "not least" emphasizes how God\'s plan elevates the humble and unexpected.',
