...
const mockGenerateCrossReferencePrompt =
  generateCrossReferencePrompt as jest.MockedFunction<
    typeof generateCrossReferencePrompt
  >;
...
describe('CrossReferenceAnalysisService', () => {
  ...
  const mockCrossReference: CrossReference = {
    ...
    reasoning:
      "These verses both highlight the central Christian message of God's love expressed through Christ's sacrificial death for humanity.",
  };
  ...
  describe('analyzeCrossReference', () => {
    ...
    it('should analyze cross-reference with default configuration', async () => {
      ...
      jest
        .spyOn(LLMClientFactory.prototype, 'getDefaultProvider')
    ...
    it('should analyze with custom configuration', async () => {
      const mockProvider = new MockLLMProvider();
      jest
        .spyOn(LLMClientFactory.prototype, 'getProvider')
        .mockResolvedValue(mockProvider as any);
    ...
    it('should handle errors gracefully', async () => {
      mockGenerateCrossReferencePrompt.mockRejectedValue(
  ...
  describe('analyzeCrossReferenceStream', () => {
    ...
    it('should stream analysis response', async () => {
      ...
      expect(chunks[2].metadata.prompt_used).toBe(
