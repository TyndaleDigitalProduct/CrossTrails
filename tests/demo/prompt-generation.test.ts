...
describe('Demo Prompt Generation', () => {
  it('should generate prompt for Matt.2.1 -> Luke.1.5 cross-reference', async () => {
    ...
    console.log(`Categories: ${crossReference.connection.categories.join(', ')}`)
    ...
    console.log(`Anchor context: ${result.sources.anchor_verse.context?.length || 0} verses`)
    ...
    console.log(`Cross-ref context: ${result.sources.cross_reference.context?.length || 0} verses`)
